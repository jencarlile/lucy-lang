...
// The order of these constants indicate mathematical precedence, e.g. * has higher precedence than +
const (
	_ int = iota
	LOWEST
	EQUALS      // ==
...
type (
	...
	// TODO [JAC]: consider adding support for postfix operators eg. x++
)
...
type Parser struct {
	...
	// Each token can have a prefix or an infix parsing function
